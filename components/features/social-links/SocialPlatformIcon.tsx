...
import { Globe, Linkedin, Youtube, Link2 } from 'lucide-react';
...
/**
 * Renders the appropriate platform icon.
 */
export function SocialPlatformIcon({ platform, className }: SocialPlatformIconProps) {
  ...
  switch (platform) {
    ...
    case 'x':
      return <XIcon className={classes} />;
    case 'linkedin':
      return <Linkedin className={classes} />;
    case 'tiktok':
      return <TikTokIcon className={classes} />;
    case 'youtube':
